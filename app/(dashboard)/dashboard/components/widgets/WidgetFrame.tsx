  ...
  if (mode === "small") {
    return (
      <button
        ...
        className="w-[160px] h-[100px] bg-white rounded-xl border border-neutral-200 shadow-sm hover:shadow-md transition flex flex-col justify-center px-4 text-left"
      >
